...
const SocialMedia = () => {
    return (
        ...
        <a href="https://www.jdmart.com/GOJ-ENZ1631687855?skip" target="_blank" rel="noreferrer">
          <img src="../../assets/logos/justdial.png" height="50px" width="100px" alt="Just Dial Logo"/>
        </a>
        <a href="https://www.indiamart.com/indelecttechonologies/" target="_blank" rel="noreferrer">
          <img src="../../assets/logos/indiamart-1.png" height="50px" width="100px" alt="India Mart Logo"/>
        </a>
      </div>
    )
}
